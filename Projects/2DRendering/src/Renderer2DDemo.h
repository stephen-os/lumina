...
namespace Lumina
{
    class Renderer2DDemo : public Layer
    {
    public:
        ...
        virtual void OnAttach() override
        {
            ...
            m_Quad.TextureCoords = m_Atlas->GetTextureCoords(m_TextureIndex);
        ...
        virtual void OnUpdate(float ts) override
        {
            ...
            if (m_Animate)
            {
                m_Quad.Rotation.x = glm::radians(45.0f) * sin(m_RotationTime);
                m_Quad.Rotation.y = glm::radians(90.0f) * cos(m_RotationTime * 0.8f);
                m_Quad.Rotation.z = glm::radians(60.0f) * sin(m_RotationTime * 1.2f);
            }
        }
        ...
        virtual void OnUIRender() override
        {
            ...
            ImGui::DragFloat3("Cube Position", glm::value_ptr(m_Quad.Position), 0.01f);
            ImGui::DragFloat3("Cube Rotation", glm::value_ptr(m_Quad.Rotation), 0.01f);
            ImGui::DragFloat3("Cube Size", glm::value_ptr(m_Quad.Size), 0.01f);
            ...
            if (ImGui::Button("Reset Rotation"))
            {
                m_RotationTime = 0.0f;
                m_Animate = false;
                m_Quad.Rotation = { 0.0f, 0.0f, 0.0f };
            }
            ImGui::End();
