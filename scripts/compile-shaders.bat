...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\quad_vs_spirv.h" -Vn g_quad_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\quad.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile quad vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\quad_ps_spirv.h" -Vn g_quad_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\quad.hlsl" -O3
...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\line_vs_spirv.h" -Vn g_line_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\line.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile line vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\line_ps_spirv.h" -Vn g_line_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\line.hlsl" -O3
...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\circle_vs_spirv.h" -Vn g_circle_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\circle.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile circle vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\circle_ps_spirv.h" -Vn g_circle_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\circle.hlsl" -O3
...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\text_vs_spirv.h" -Vn g_text_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\text.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile text vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\text_ps_spirv.h" -Vn g_text_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\text.hlsl" -O3
...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\triangle_vs_spirv.h" -Vn g_triangle_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\triangle.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile triangle vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\triangle_ps_spirv.h" -Vn g_triangle_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\triangle.hlsl" -O3
...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\pixel_vs_spirv.h" -Vn g_pixel_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\pixel.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile pixel vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\pixel_ps_spirv.h" -Vn g_pixel_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\pixel.hlsl" -O3
...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\grid_vs_spirv.h" -Vn g_grid_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\grid.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile grid vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\grid_ps_spirv.h" -Vn g_grid_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\grid.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile grid pixel shader for SPIR-V & exit /b 1 )

REM ============================================================================
REM Point Light shader
REM ============================================================================
echo   point_light.hlsl...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\point_light_vs_dxil.h" -Vn g_point_light_vs_dxil "%SHADER_DIR%\point_light.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile point_light vertex shader for DXIL & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\point_light_ps_dxil.h" -Vn g_point_light_ps_dxil "%SHADER_DIR%\point_light.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile point_light pixel shader for DXIL & exit /b 1 )

"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\point_light_vs_spirv.h" -Vn g_point_light_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\point_light.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile point_light vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\point_light_ps_spirv.h" -Vn g_point_light_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\point_light.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile point_light pixel shader for SPIR-V & exit /b 1 )

REM ============================================================================
REM Composite shader
REM ============================================================================
echo   composite.hlsl...
"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\composite_vs_dxil.h" -Vn g_composite_vs_dxil "%SHADER_DIR%\composite.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile composite vertex shader for DXIL & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\composite_ps_dxil.h" -Vn g_composite_ps_dxil "%SHADER_DIR%\composite.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile composite pixel shader for DXIL & exit /b 1 )

"%DXC_PATH%" -T vs_6_0 -E VSMain -Fh "%OUTPUT_DIR%\composite_vs_spirv.h" -Vn g_composite_vs_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\composite.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile composite vertex shader for SPIR-V & exit /b 1 )

"%DXC_PATH%" -T ps_6_0 -E PSMain -Fh "%OUTPUT_DIR%\composite_ps_spirv.h" -Vn g_composite_ps_spirv -spirv -fvk-t-shift 0 0 -fvk-s-shift 32 0 -fvk-b-shift 64 0 "%SHADER_DIR%\composite.hlsl" -O3
if errorlevel 1 ( echo ERROR: Failed to compile composite pixel shader for SPIR-V & exit /b 1 )
...
REM Point Light combined
echo // Auto-generated combined point_light shader header > "%OUTPUT_DIR%\point_light_vs.h"
echo #pragma once >> "%OUTPUT_DIR%\point_light_vs.h"
echo #include "point_light_vs_dxil.h" >> "%OUTPUT_DIR%\point_light_vs.h"
echo #include "point_light_vs_spirv.h" >> "%OUTPUT_DIR%\point_light_vs.h"

echo // Auto-generated combined point_light shader header > "%OUTPUT_DIR%\point_light_ps.h"
echo #pragma once >> "%OUTPUT_DIR%\point_light_ps.h"
echo #include "point_light_ps_dxil.h" >> "%OUTPUT_DIR%\point_light_ps.h"
echo #include "point_light_ps_spirv.h" >> "%OUTPUT_DIR%\point_light_ps.h"

REM Composite combined
echo // Auto-generated combined composite shader header > "%OUTPUT_DIR%\composite_vs.h"
echo #pragma once >> "%OUTPUT_DIR%\composite_vs.h"
echo #include "composite_vs_dxil.h" >> "%OUTPUT_DIR%\composite_vs.h"
echo #include "composite_vs_spirv.h" >> "%OUTPUT_DIR%\composite_vs.h"

echo // Auto-generated combined composite shader header > "%OUTPUT_DIR%\composite_ps.h"
echo #pragma once >> "%OUTPUT_DIR%\composite_ps.h"
echo #include "composite_ps_dxil.h" >> "%OUTPUT_DIR%\composite_ps.h"
echo #include "composite_ps_spirv.h" >> "%OUTPUT_DIR%\composite_ps.h"
