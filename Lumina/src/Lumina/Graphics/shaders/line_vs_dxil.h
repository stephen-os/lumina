...
; COLOR                    0   xyzw        1     NONE   float   xyzw
;
; shader hash: 9328459c92205cf12d121aec8df00599
;
...
define void @VSMain() {
  ...
  %28 = call float @dx.op.tertiary.f32(i32 46, float %19, float %8, float %27)  ; FMad(a,b,c)
  %29 = fadd fast float %28, %23
  %30 = fmul fast float %12, %6
  %31 = call float @dx.op.tertiary.f32(i32 46, float %16, float %7, float %30)  ; FMad(a,b,c)
  %32 = call float @dx.op.tertiary.f32(i32 46, float %20, float %8, float %31)  ; FMad(a,b,c)
  %33 = fadd fast float %32, %24
  %34 = fmul fast float %13, %6
  %35 = call float @dx.op.tertiary.f32(i32 46, float %17, float %7, float %34)  ; FMad(a,b,c)
  %36 = call float @dx.op.tertiary.f32(i32 46, float %21, float %8, float %35)  ; FMad(a,b,c)
...
!7 = !{[10 x i32] [i32 8, i32 8, i32 11, i32 11, i32 11, i32 4, i32 16, i32 32, i32 64, i32 128]}
...
const unsigned char g_line_vs_dxil[] = {
  0x44, 0x58, 0x42, 0x43, 0x81, 0x25, 0x20, 0x52, 0x5a, 0x5d, 0x63, 0xc5,
  0xcc, 0x3e, 0x64, 0x72, 0x06, 0x66, 0xa0, 0x5e, 0x01, 0x00, 0x00, 0x00,
  0xa0, 0x0f, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, 0x00,
  0x4c, 0x00, 0x00, 0x00, 0xac, 0x00, 0x00, 0x00, 0x10, 0x01, 0x00, 0x00,
  0x00, 0x02, 0x00, 0x00, 0x3c, 0x08, 0x00, 0x00, 0x58, 0x08, 0x00, 0x00,
  ...
  0xe8, 0x00, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
  ...
  0xe7, 0x00, 0x86, 0x88, 0x80, 0x14, 0x88, 0x00, 0x46, 0x42, 0x81, 0xa5,
  ...
  0x04, 0x85, 0x50, 0x06, 0xe5, 0x50, 0x12, 0xe5, 0x51, 0x5c, 0x05, 0x41,
  0xa5, 0x24, 0x46, 0x00, 0x0a, 0xa1, 0x0c, 0x8a, 0x80, 0xee, 0x0c, 0x00,
  0xe1, 0x19, 0x00, 0xca, 0x63, 0x29, 0x08, 0xb2, 0x2c, 0x0b, 0x01, 0x81,
  ...
  0x86, 0x03, 0x21, 0x26, 0x08, 0x18, 0x46, 0x66, 0x28, 0xac, 0xad, 0x4c,
  0x2e, 0x0c, 0x2a, 0x4c, 0x2e, 0xac, 0x6d, 0x6e, 0x82, 0x40, 0x24, 0x1b,
  0x10, 0x42, 0x59, 0x08, 0x62, 0x60, 0x80, 0x0d, 0x41, 0xb3, 0x81, 0x00,
  0x00, 0x07, 0x98, 0x20, 0x5c, 0x17, 0xa1, 0xba, 0x2f, 0xab, 0xb4, 0xb2,
  ...
  ,
  ...
  0x42, 0xe6, 0xd5, 0x21, 0xc3, 0x73, 0xb1, 0x4b, 0x2b, 0xbb, 0x4b, 0x22,
  0x9b, 0xa2, 0x0b, 0xa3, 0x2b, 0x9b, 0x12, 0x80, 0x41, 0x1d, 0x32, 0x3c,
  ...
  0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x93, 0x28, 0x45, 0x9c,
  0x92, 0x20, 0x5c, 0xf1, 0x2d, 0x12, 0x1a, 0xec, 0x8d, 0xf0, 0x05, 0x99,
  0x44, 0x58, 0x49, 0x4c, 0x40, 0x07, 0x00, 0x00, 0x60, 0x00, 0x01, 0x00,
  ...
  0xa0, 0x10, 0xca, 0xa0, 0x08, 0x08, 0xcf, 0x00, 0x50, 0x1e, 0x4b, 0x41,
  0x90, 0x65, 0x59, 0x08, 0x08, 0x0c, 0x40, 0x01, 0x24, 0x00, 0x00, 0x00,
  ...
  0xc0, 0x24, 0x02, 0x13, 0x04, 0x42, 0xd9, 0x80, 0x10, 0x0b, 0x43, 0x10,
  ...
  0xf4, 0x24, 0xb5, 0x61, 0x19, 0x3c, 0xeb, 0xc2, 0xae, 0x21, 0x1b, 0x2e,
  0x6e, 0x83, 0xd0, 0x7d, 0x5c, 0xa6, 0xac, 0xbe, 0xa0, 0xde, 0xe6, 0xd2,
  0xe8, 0xd2, 0xde, 0xdc, 0x26, 0x08, 0x05, 0xb4, 0x61, 0x21, 0xc2, 0xc0,
  0x12, 0x03, 0x2c, 0x1b, 0x32, 0xe2, 0xe2, 0x26, 0x08, 0x45, 0xb4, 0x61,
  0x19, 0x3c, 0xeb, 0xc2, 0xc8, 0x60, 0xc8, 0x86, 0x8b, 0xdb, 0x20, 0x8c,
  0x41, 0x19, 0x6c, 0x18, 0xc0, 0xc0, 0x0c, 0x80, 0x0d, 0xc5, 0x44, 0x9d,
  0x01, 0x04, 0x54, 0x61, 0x63, 0xb3, 0x6b, 0x73, 0x49, 0x23, 0x2b, 0x73,
  ...
  
};
