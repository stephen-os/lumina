project "catch2"
    ...
    files
    {
        "%{wks.location}/Lumina/vendor/catch2/src/catch2/**.cpp",
        "%{wks.location}/Lumina/vendor/catch2/src/catch2/**.hpp"
    }

    removefiles
    {
        "%{wks.location}/Lumina/vendor/catch2/src/catch2/internal/catch_main.cpp"
    }
